...
public class TC15_TestNG_PlaceOrder_RegisterBeforeCheckout 
{
	WebDriver driver;
	...
	public void homepagetitleVerification() throws InterruptedException
	{
		...
		//fill signup details
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("viratkohli");
		driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("vk2011@gmail.com");
		driver.findElement(By.xpath("//button[@data-qa='signup-button']")).click();
		Thread.sleep(2000);
		
		//register to create account by filling all details
		driver.findElement(By.xpath("//input[@type='radio']")).click();
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("Viratkoh@1111");
		...
		driver.findElement(By.xpath("//input[@data-qa='first_name']")).sendKeys("viratkohli");
		driver.findElement(By.xpath("//input[@data-qa='last_name']")).sendKeys("koti");
	...
	{
		boolean LoginasUN = driver.findElement(By.xpath("//*[text()='viratkohli']")).isDisplayed();
